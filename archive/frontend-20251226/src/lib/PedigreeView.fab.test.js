/**
 * Unit tests for PedigreeView - Floating Action Button Removal.
 * Tests that PedigreeView does not have a floating add person button.
 *
...
describe('PedigreeView - Floating Action Button Removal', () => {
  beforeEach(() => {
